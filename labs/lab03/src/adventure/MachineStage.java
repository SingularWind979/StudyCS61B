...
public class MachineStage implements AdventureStage {
    ...
    public void playStage() {
        ...
        while (true) {
            ...
            System.out.println("The machine whirrs briefly before outputting a slip of paper, "
                    + "reading " + machineResult);
    ...
    public static int sumOfElementwiseMax(int[] a, int[] b) {
        ...
        if (maxes == null) {
            throw  new RuntimeException("ERROR! Array lengths don't match");
        }
