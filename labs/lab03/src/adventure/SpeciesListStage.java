...
public class SpeciesListStage implements AdventureStage {
    ...
    public void playStage() {
        ...
        System.out.println("- This native American bovine can be found in the plains, "
                + "and happens to be EXTREMELY good at Java.");
        ...
        System.out.println("- These bushy-tailed friends are everywhere in and around the trees on campus, "
                + "and know the best parts of Java.");
        System.out.println("- These tiny birds flap very fast, drink nectar, "
                + "and know how to make simpler Java applications.");
        System.out.println("- Type their names into the terminal (separated by ',')");
    ...
    /**
     * Computes the similarity of two lists as a ratio.
     * If all elements match, returns 1.0. If no elements match, returns 0.0.
     */
