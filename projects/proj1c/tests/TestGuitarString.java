...
public class TestGuitarString  {
    ...
    public void testSample() {
        ...
        assertWithMessage(errorMsg).
                that(s.sample()).isWithin(0.0).of(sample);
        assertWithMessage(errorMsg).
                that(s.sample()).isWithin(0.0).of(sample);
    }
    ...
    public void testTicCalculations() {
        // Create a GuitarString of frequency 11025,
        // which is a Deque61B of length 4.
        GuitarString s = new GuitarString(11025);
        s.pluck();

        // Record the front four values, tic as we go.
        double s1 = s.sample();
        s.tic();
        double s2 = s.sample();
        s.tic();
        ...
        String errorMsg = "Wrong tic value. "
                + "Try running the testTic method "
                + "in TestGuitarString.java";
