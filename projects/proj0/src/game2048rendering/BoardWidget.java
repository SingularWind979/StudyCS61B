...
class BoardWidget extends Pad {
    ...
    /** Bar width separating tiles
     *  and length of tile's side (pixels). */
    static final int
        TILE_SEP = 15,
        TILE_SIDE = 100,
    ...
    static final Font TILE_FONT2 = new Font("SansSerif", Font.BOLD, 48);
    /** Font used for numbering on tiles with 3 digits. */
    static final Font TILE_FONT3 = new Font("SansSerif", Font.BOLD, 40);
    /** Font used for numbering on tiles with 4 digits. */
    static final Font TILE_FONT4 = new Font("SansSerif", Font.BOLD, 32);

    /** Color for overlay text on board. */
    static final Color OVERLAY_COLOR = new Color(200, 0, 0, 64);

    /** Font for overlay text on board. */
    static final Font OVERLAY_FONT = new Font("SansSerif", Font.BOLD, 64);
    ...
    /** Mapping from numbers on tiles
     *  to their text and background colors. */
    static final HashMap<Integer, Color[]> TILE_COLORS = new HashMap<>();

    /** List of tile values
     *  and corresponding background and foreground color values. */
    ...
    /** Distance tiles have moved toward their next positions,
     *  in units of rows and columns. */
