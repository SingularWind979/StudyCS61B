...
/**
 * Represents a 2048 board of tiles.
 *
 * @author hug
 */
...
public class Board {
    ...
    /**
     * Create a board
     * where RAW VALUES hold the values of the tiles on the board
     * (0 is null)
    ...
    /**
     * Places the Tile TILE at column x, row y
     * where x and y are treated as coordinates
