...
public enum Side {
     ...
     *      The board's standard orientation has the top of the board as NORTH,
     *      and rows and columns (see Model) are numbered from its lower-left corner.
     *      Consider the board oriented so that side D of the board is farthest from you.
     *      Then
     *          * (COL0*s, ROW0*s) are the standard coordinates
     *            of the lower-left corner of the reoriented board
     *            (where s is the board size), and
     *          * If (x, y) are the standard coordinates
     *            of a certain square on the reoriented board,
     *            then (x+DCOL, y+DROW) are the standard coordinates
     *            of the squares immediately above it on the reoriented board.
     *  By using the x() and y() methods below
     *  to translate from reoriented to standard coordinates,
     *  one can reuse the same code to compute
     *  the result of tilting the board in any direction.
     */
    ...
    /**
     * The side that is in the direction (DCOL, DROW)
     * from any square of the board.
     * Here, direction (DCOL, DROW) means that to
     * move one space in the direction of this Side
