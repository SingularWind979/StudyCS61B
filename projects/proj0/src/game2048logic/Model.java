...
public class Model {
    ...
    /**
     * A new 2048 game
     * where RAW VALUES contain the values of the tiles
     * (0 if null).
     ...
     * Rules for Tilt:
     * 1. If two Tiles are adjacent in the direction of motion and have the same value,
     *    they are merged into one Tile of twice the original value
     *    and that new value is added to the score instance variable
