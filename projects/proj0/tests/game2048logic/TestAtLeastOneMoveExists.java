 ...
 * You shouldn't expect to pass these tests
 * until you're passing all the tests in TestEmptySpace.
 *
 * @author Omar Khan
 */
...
public class TestAtLeastOneMoveExists {
     ...
     * Note that this isn't a comprehensive test for empty space.
     * For that, see the TestEmptySpace class.
     */
    @Test
     ...
     * While having the max tile on the board does mean the game is over,
     * it should not be handled in this method.
     */
    @Test
    @Tag("at-least-one-move-exists")
